(function () {
    ...
    function buildIframeUrl(baseUrl, token){
        try{
          var u = new URL(baseUrl || "https://phpstack-508481-5298655.cloudwaysapps.com", location.href);
          if (token) u.searchParams.set('token', token);
          return u.toString();
        }catch(e){
          if (!baseUrl) return "https://phpstack-508481-5298655.cloudwaysapps.com";
  ...
  function fetchSessionToken(endpoint, clientToken, sessionId){
    ...
    function openModal() {
      ...
      var baseUrl = stripTokenParam(cfg.iframeSrc) || "https://phpstack-508481-5298655.cloudwaysapps.com";
